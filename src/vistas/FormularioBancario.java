...
public class FormularioBancario extends javax.swing.JFrame {
    ...
    int idEmp = Integer.parseInt(txtIdEmpresa.getText().trim());
    String ban = txtBanco.getText().trim().toUpperCase();
    ...
    for (CuentaBancaria c : listaCuentas) {
        if (c.getNumeroCuenta().equalsIgnoreCase(num)) {
            JOptionPane.showMessageDialog(
                    this,
                    "La cuenta ya existe.",
                    "Duplicado",
    ...
    boolean guardado = dao.guardar(nueva);
    ...
    JOptionPane.showMessageDialog(
            this,
            "El ID y el saldo deben ser numéricos.",
            "Error",
            JOptionPane.ERROR_MESSAGE
    );
